...
--
-- Host: localhost:3380
-- Generation Time: Apr 18, 2015 at 09:23 AM
...
(4, 'copyright', 'copyright notice for the site', '<h5>Copyright Notice</h5>', '', '', '', '', '2014-01-29 05:20:14'),
(3, 'contact', 'contact page for Chinese culture tutorial site', 'dluo1@luc.edu', '', '', '', '', '2014-01-29 04:49:28'),
...
(1, 'home', 'default home page for the Chinese culture tutorial site', 'welcome to the home page of the Chinese culture tutorial site欢迎光临！', '', '', '', '', '2014-01-28 07:16:40'),
...
(31, 'Three Gorges', 'map of three gorges', '', '', '31.0202773,109.6111111,15', '', '', '2015-04-17 02:34:52'),
(30, 'atlases', 'an overview of current site atlases', '<h5>atlases</h5>', '', '', '', '', '2014-04-05 22:03:01'),
(10, 'Palace Museum - 故宫', 'An overview look of Palace Museum in Beijing', '', 'bj_img1.jpg', '', '', '', '2014-04-07 06:27:38'),
...
(10, 'China Tour book - 中国行', 'a book about China Tour', 'content/text/book&id=3'),
...
(21, 'AudioGallery', '', 'content/audio/audiogallery&id=6'),
(22, 'VideoGallery', '', 'content/video/videogallery&id=5');
...
--
ALTER TABLE `content`
MODIFY `contentid` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `node`
MODIFY `node_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
-- AUTO_INCREMENT for table `plugins`
--
ALTER TABLE `plugins`
MODIFY `plugin_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT for table `taxonomy`
--
ALTER TABLE `taxonomy`
MODIFY `taxa_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
